...
import 'package:kf_ess_mobile_app/features/profile/presentation/cubits/custom_file_picker/custom_file_picker_widget.dart';
import 'package:kf_ess_mobile_app/features/shared/widgets/custom_elevated_button_widget.dart';

import '../../../shared/widgets/app_text.dart';

class FilePickerFamilyButton extends StatelessWidget {
  final FilePickerFamilyCubit filePickerFamilyCubit;

  const FilePickerFamilyButton({required this.filePickerFamilyCubit});
    ...
    return CustomElevatedButton(
      ...
      onPressed: () {
        ViewsToolbox.showBottomSheet(
          height: 400.h,
          context: context,
          widget: GenericFileFamilyPicker(
            filePickerFamilyCubit: filePickerFamilyCubit,
            keyName: 'file',
            buttonTitle: context.tr("attach_file"),
            isFromCamera: true,
            isFromGallery: true,
            isFromFile: true,
          ),
      ...
      customChild: Row(
        ...
        children: [
          ...
          5.horizontalSpace,
          AppText(
            text: context.tr("please_attach_file"),
