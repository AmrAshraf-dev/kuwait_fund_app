...
part 'more_request_model.g.dart';
...
@JsonSerializable()
class MoreRequestModel {
  MoreRequestModel({required this.email, required this.lang});

  factory MoreRequestModel.fromJson(Map<String, dynamic> json) =>
      _$MoreRequestModelFromJson(json);
  final String? email;
  final String? lang;

  Map<String, dynamic> toJson() => _$MoreRequestModelToJson(this);
}
