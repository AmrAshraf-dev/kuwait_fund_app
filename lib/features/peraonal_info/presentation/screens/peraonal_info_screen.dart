                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PersonalInfoItem(title: context.tr("employeeNumber"), body: "876887"),
                      PersonalInfoItem(title: context.tr("fullName"), body: "Ahmad Riyad Abdel"),
                      PersonalInfoItem(title: context.tr("civil_id"), body: "TE987345"),
                      PersonalInfoItem(title: context.tr("residencyExpiryDate"), body: "12/3/2030"),
                      PersonalInfoItem(title: context.tr("nationaliy"), body: "Jordan"),
                      PersonalInfoItem(title: context.tr("passportNo"), body: "TE987345"),
                      PersonalInfoItem(title: context.tr("passportExpiryDate"), body: "12/3/2030"),
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      PersonalInfoItem(title: context.tr("contractType"), body: "Work" , withDivider: false),
                      8.verticalSpace,
                      PersonalInfoItem(title: context.tr("jobTitle"), body: "Project Manager" , withDivider: false),
                      8.verticalSpace,
                      PersonalInfoItem(title: context.tr("contractStartDate"), body: "12/3/2022" , withDivider: false),
                      8.verticalSpace,
                      PersonalInfoItem(title: context.tr("contractEndDate"), body: "12/3/2030" , withDivider: false),
                      8.verticalSpace,
                      PersonalInfoItem(title: context.tr("joiningDate"), body: "12/3/2030" , withDivider: false),
                    ],
                  ),
                ),
              ),
