...
class PollCardItemWidget extends StatelessWidget {
  const PollCardItemWidget({super.key, required this.item});

  final PollEntity item;
  @override
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                    CustomMainRouter.push(PollDetailsRoute(pollItem: item));
              },
