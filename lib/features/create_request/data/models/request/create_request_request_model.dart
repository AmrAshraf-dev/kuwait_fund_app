...
part 'create_request_request_model.g.dart';
...
class CreateRequestRequestModel {
  CreateRequestRequestModel({required this.email, required this.lang});

  factory CreateRequestRequestModel.fromJson(Map<String, dynamic> json) =>
      _$CreateRequestRequestModelFromJson(json);
  final String? email;
  final String? lang;

  Map<String, dynamic> toJson() => _$CreateRequestRequestModelToJson(this);
}
