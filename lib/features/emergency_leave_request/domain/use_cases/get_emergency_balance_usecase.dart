...
@injectable
class GetEmergencyLeaveBalanceUseCase
    implements UseCaseNoParam<BaseEntity<dynamic>> {
  GetEmergencyLeaveBalanceUseCase({required this.createRequestRepository});

  final EmergencyLeaveRequestRepository createRequestRepository;

  @override
  Future<CustomResponseType<BaseEntity<dynamic>>> call() {
    return createRequestRepository.getEmergencyLeaveBalance();
  }
}
