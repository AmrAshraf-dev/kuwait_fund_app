...
class EmergencyLeaveAvailableDaysWidget extends StatelessWidget {
  EmergencyLeaveAvailableDaysWidget({
    super.key,
    required this.emergencyLeaveRequestCubit,
  });
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<EmergencyLeaveRequestCubit, EmergencyLeaveScreenState>(
                                ...
                                child: Center(
                                  child: Padding(
                                    ...
                                    child: Directionality(
                                      ...
                                      child: AppText(
                                          text: state.response.data?.emergencyLabel.toString(),
