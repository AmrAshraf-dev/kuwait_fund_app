...
class EmergencyLeaveAvailableDaysWidget extends StatelessWidget {
  ...
  final EmergencyAvailableDaysCubit emergencyAvailableDaysCubit =
      getIt<EmergencyAvailableDaysCubit>();
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => emergencyAvailableDaysCubit,
      child:
          BlocBuilder<EmergencyAvailableDaysCubit, EmergencyAvailableDaysState>(
        builder: (context, state) {
          if (state is EmergencyAvailableDaysLoadingState) {
            ViewsToolbox.showLoading();
          } else if (state is EmergencyAvailableDaysErrorState) {
            ViewsToolbox.dismissLoading();
            ViewsToolbox.showErrorAwesomeSnackBar(context, state.message!);
          } else if (state is EmergencyAvailableDaysReadyState) {
            ViewsToolbox.dismissLoading();
            return Container(
